            ...
            return (
              ...
              >
                <div className="p-4 sm:p-6 flex flex-col gap-4 sm:gap-6">
                  <div className="aspect-square size-12 sm:size-16 grid place-content-center rounded-sm border border-violet-400/40 bg-background shadow-md transition-transform duration-300 group-hover:scale-110 group-hover:rotate-2 group-hover:border-violet-500">
                    <Icon
                      size={20}
