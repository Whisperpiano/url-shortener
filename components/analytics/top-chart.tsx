...
export default function TopChart({ data }: { data: DataType }) {
  ...
  const processedData = isEmpty ? [] : ProcessDataChart(activeData);
  const chartConfiguration = isEmpty ? {} : ProcessChartConfig(processedData);
        ...
        {isEmpty ? (
          <div className="w-full h-[200px] flex items-center justify-center relative">
            <div className="w-[160px] h-[160px] relative">
              ...
              <div className="absolute inset-[30px] rounded-full border-2 border-muted/15"></div>
